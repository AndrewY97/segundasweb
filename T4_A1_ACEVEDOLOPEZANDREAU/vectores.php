	...
	<table class='table'>
		<thead class='thead-dark'>
			<th scope='col'>Materia</th>
      		<th scope='col'>Sistemas Programables</th>
      		<th scope='col'>Programacion Web</th>
      		<th scope='col'>Programacion Paralela</th>
      		<th scope='col'>Redes de Computadoras</th>
      		<th scope='col'>Lenguajes y Automatas</th>
      		<th scope='col'>Taller de Investigacion</th>
